	...
	var refcon = {
			...
			if (document.getElementById('ca-edit')) {
				...
				if (typeof document.forms.editform !== 'undefined') {
					portletlink.on('click', function (e) {
						...
						// If WikEd is enabled, copy the text from the WikEd textbox to the main textbox
						if (typeof(window.wikEd) !== 'undefined' && typeof(window.wikEd.useWikEd) !== 'undefined') {
		...
		commit: function () {
			...
			if (oldText != newText) {
				...
				// If WikEd is enabled, update the WikEd textbox
				if (typeof(window.wikEd) !== 'undefined' && typeof(window.wikEd.useWikEd) !== 'undefined') {
					if (window.wikEd.useWikEd == true) {
						wikEd.UpdateFrame();
					}
